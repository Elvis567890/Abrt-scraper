...
# ---- Asian Handicap, Double Chance, BTTS for 1xBet/22Bet/Melbet ----
...
# ============================
# FLASK SERVER – only runs if executed directly
# ============================
if __name__ == "__main__":
    # Import Flask and dependencies only when running the server
