    ...
    try:
        ...
        for match in matches:
            ...
            try:
                ...
                home_odd, draw_odd, away_odd = extract_championbet_1x2(
                    bet_map
                )
                ...
                over_odd, under_odd = extract_championbet_ou(
                    bet_map
                )
                ...
                ah_odds, dc_odds, btts_odds = extract_championbet_extra(
                    bet_map
                )
...
def scrape_fortebet() -> List[Dict[str, Any]]:
    ...
    try:
        url = (
            "https://desktop.fortebet.ug/api/web/v1/"
            "offer/full-prematch-en"
        )
...
def complete_arb():
    ...
    try:
        ...
        logger.exception(
            "Failed to record completed arb: %s",
            exc,
        )
...
# =============================================================================
# Sitemap and robots.txt - Google Search Console
# =============================================================================
